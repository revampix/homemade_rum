...
# Dump of table google_analytics_reference
# ------------------------------------------------------------

CREATE TABLE `google_analytics_reference` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `analytics_client_id` varchar(30) NOT NULL DEFAULT '',
  `guid` varchar(36) DEFAULT NULL,
  `page_view_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
